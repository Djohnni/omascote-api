...
Piloto e flags: `RADAR_AMISTOSOS_ENABLED`, `RADAR_SEARCH_ENABLED`, `RADAR_INVITATIONS_ENABLED`, `RADAR_MATCH_CENTER_ENABLED`, `RADAR_MATCH_RESULTS_ENABLED`, `RADAR_MATCH_HISTORY_ENABLED`, `RADAR_REPUTATION_ENABLED`, `RADAR_MODERATION_ENABLED`, `RADAR_PROFILE_PRINT_IMPORT_ENABLED`, `RADAR_PILOT_ACCOUNT_ALLOWLIST`, `RADAR_PILOT_CITY_IBGE_CODE`, `RADAR_MODERATION_SLA_HOURS`.
